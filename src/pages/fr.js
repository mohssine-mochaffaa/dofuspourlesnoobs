            ...
            <div className={styles.mainrightInfos}>
              ...
              <ul>
                ...
                <Link className={styles.link} href={{
                  pathname:pageLink,
                }} style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow>https://dofus.com/fr/mmorpg/actualites <div style={{marginLeft:"12px",marginTop:"-15px"}} className="underline"><br /></div>/news/mine-valoniale/</Link>
